    ...
    <main className="w-full flex flex-col min-h-screen bg-white text-black font-[family-name:var(--font-quicksand)] selection:bg-black selection:text-white">
      ...
      <section className="relative w-full h-[50vh] md:h-[60vh] flex flex-col justify-center items-center overflow-hidden bg-[#fafafa] pt-20 border-b border-black/10">
        <div className="relative z-10 flex flex-col items-center text-center px-6 mt-10 max-w-[900px]">
          <p className="text-[14px] md:text-[18px] font-[family-name:var(--font-raleway)] text-black/50 uppercase tracking-[0.2em] mb-4">
            CANTONES DE COSTA RICA
          </p>
          <h1 className="text-[36px] md:text-[60px] font-[family-name:var(--font-raleway)] font-light text-black tracking-[0.2em] uppercase mb-8 leading-tight">
            ÁREAS DE EXPERIENCIA
          </h1>
          <p className="text-[16px] md:text-[20px] text-black/80 font-[family-name:var(--font-quicksand)] leading-[1.6]">
      ...
      <section className="bg-[#eeeeee] py-[100px] px-6 text-center flex flex-col items-center border-t border-black/10">
         <h2 className="text-[32px] md:text-[40px] font-[family-name:var(--font-raleway)] font-light uppercase tracking-[0.2em] text-black mb-4 max-w-[800px] leading-tight">
           COMIENCE SU BÚSQUEDA DE PROPIEDADES
         </h2>
         <a href="/portal" className="mt-8 inline-block px-12 py-5 bg-black text-white text-[12px] uppercase tracking-[0.2em] font-medium hover:bg-transparent hover:text-black border border-black transition-colors">
           EXPLORAR CASAS
         </a>
      </section>
