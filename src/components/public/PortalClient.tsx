         ...
         <div className="max-w-[1000px] mx-auto px-6 py-6 flex flex-col md:flex-row gap-6 items-center justify-center">
            ...
            <div className="flex flex-wrap md:flex-nowrap gap-6 w-full md:w-auto justify-center">
               <div className="relative w-full md:w-[280px] group">
                  <Home className="absolute left-6 top-1/2 -translate-y-1/2 w-4 h-4 text-black/40 group-hover:text-black transition-colors duration-500" />
                  <select 
                    value={propertyType}
                    onChange={(e) => setPropertyType(e.target.value)}
                    className="w-full pl-14 pr-10 py-4 bg-transparent border border-black/10 rounded-full text-[11px] uppercase tracking-[0.2em] outline-none appearance-none cursor-pointer hover:border-black transition-all duration-500 text-black font-medium"
                  >
                  ...
                  <div className="absolute right-6 top-1/2 -translate-y-1/2 pointer-events-none">
                     <div className="w-2 h-2 border-b border-r border-black/40 rotate-45 transform -translate-y-1 group-hover:border-black transition-colors duration-500"></div>
                  </div>
               </div>

               <div className="relative w-full md:w-[280px] group">
                  <DollarSign className="absolute left-6 top-1/2 -translate-y-1/2 w-4 h-4 text-black/40 group-hover:text-black transition-colors duration-500" />
                  <select 
                    value={priceRange}
      ...
      <section className="w-full py-[80px] px-6">
         <div className="max-w-[1400px] mx-auto">
            <div className="flex flex-col md:flex-row justify-between md:items-end mb-8 border-b border-black/10 pb-4 gap-4">
               <span className="text-[13px] text-black/60 uppercase tracking-[0.1em]">
               ...
               <select 
                 ...
                 className="bg-transparent text-[12px] uppercase tracking-[0.1em] text-black outline-none cursor-pointer font-medium w-auto"
               >
            ...
            {displayedProperties.length > 0 ? (
               ...
               <div className="flex flex-col items-center justify-center py-32 text-black/50 animate-in fade-in duration-700">
                  <MapPin className="w-12 h-12 mb-4 opacity-20" />
                  <p className="text-[18px] font-medium text-black mb-2">No se encontraron propiedades</p>
                  ...
                  <button 
                    ...
                    className="mt-6 px-6 py-2 border border-black/20 text-[12px] uppercase tracking-wider hover:border-black transition-colors"
                  >
                    Limpiar Filtros
                  </button>
               </div>
            ...
            {filteredProperties.length > visibleCount && (
              <div className="flex justify-center mt-16">
                 <button 
                   ...
                   className="px-10 py-4 bg-transparent border border-black text-black text-[12px] uppercase tracking-[0.2em] hover:bg-black hover:text-white transition-colors duration-300"
                 >
