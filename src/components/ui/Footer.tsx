         ...
         <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-12 items-center md:items-start justify-between">
            <div className="flex flex-col items-center md:items-start text-center md:text-left md:w-1/3">
               <div className="w-32 h-32 rounded-full overflow-hidden mb-6 border-2 border-white/20">
                  <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=300&q=80" alt="Agente" className="w-full h-full object-cover" />
               </div>
            ...
            <div className="md:w-2/3 flex flex-col gap-6 text-[14px] font-[family-name:var(--font-quicksand)] items-center md:items-start text-center md:text-left">
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   ...
                   <a href={`mailto:realtor@${domain}`} className="underline underline-offset-4 hover:text-white/70 transition-colors">REALTOR@{domain.toUpperCase()}</a>
                 </div>
               </div>
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   ...
                   <a href="https://wa.me/50660413905" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-white/70 transition-colors">+506 6041 3905</a>
                 </div>
               </div>
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   ...
                   <div>SAN JOSÉ, COSTA RICA<br/>CÓDIGO POSTAL 10101</div>
                 </div>
               </div>
